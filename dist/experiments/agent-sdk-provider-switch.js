...
import { minimaxProvider } from "../providers/minimax.js.js.js";
import { zaiProvider } from "../providers/zai.js.js.js";
const providers = [
    { name: "minimax", provider: minimaxProvider },
    { name: "zai", provider: zaiProvider },
];
function setProviderEnv(provider) {
...
async function runAgentWithProvider(providerInfo, prompt) {
    console.log(`\n${"=".repeat(60)}`);
