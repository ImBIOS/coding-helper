...
/**
 * Notify command - Show desktop notifications for Claude Code events.
 *
 ...
 *
 * Usage: cohe notify [--message "default message"]
 */
export default class Notify extends BaseCommand<typeof Notify> {
  static description = "Show desktop notifications for Claude Code events";
  static examples = [
    "<%= config.bin %> notify",
    "<%= config.bin %> notify --message 'Task completed'",
  ];
